...
def setup_install():
  ...
  os.system('chown -R timwalker /opt/django') # We're using shell, because the python builtin chown doesn't work as well
...
def django_start():
  ...
  os.system('chown -R timwalker /opt/django')
  ...
  with open('project1/settings.py', "w") as f:
    ...
    os.system('sudo -u timwalker sh -c "source /opt/django/django-env/bin/activate && python manage.py runserver 0.0.0.0:8000&"')
